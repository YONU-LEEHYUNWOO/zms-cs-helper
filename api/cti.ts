...
오디오를 청취하고 통화 내용에 대해 4줄 개조식 핵심 요약과 STT 대화록을 정확히 추출해 주세요:

1) 요약 (반드시 아래 4줄 개조식 양식 엄수):
• 핵심 안건: (고객 문의 및 접수 원인 1줄)
• 고객 요구사항: (고객이 불만/문의/요청한 사항 1줄)
• 상담사 조치사항: (상담원이 안내하거나 조치한 내용 1줄)
• 처리 결과 및 상태: (결제 완료 / 차단기 개방 / 안내 완료 등 최종 결과 1줄)
