...
async function handleCtiRequest(req: any, res: any) {
  ...
  try {
    const { phoneNumber, ctiUserId, ctiUserPw, extensionFilter, selectedCallIdx, action, sessionCookie, preKnownMp3Url, userGeminiKey, startDate, endDate, startPage, endPage } = body;
