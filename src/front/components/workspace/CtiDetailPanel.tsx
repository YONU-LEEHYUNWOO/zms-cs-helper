...
import {
  Mic, Sparkles, Loader2, PhoneCall, Download, PlayCircle, FileText, Copy, Maximize2, Search, X
} from 'lucide-react';
...
export const CtiDetailPanel: React.FC<CtiDetailPanelProps> = ({
  ...
  return (
    <div className="w-1/2 flex flex-col bg-white overflow-y-auto custom-scroll p-5 gap-4">
      ...
      {showExpandedViewerModal && audioAnalysisResult && (
        <div
          ...
          onClick={() => setShowExpandedViewerModal(false)}
        >
          <div
