...
import {
  Mic, Sparkles, Loader2, PhoneCall, Download, PlayCircle, FileText, Copy
} from 'lucide-react';
              ...
              <div className="flex items-center justify-between border-b border-slate-200 pb-1">
                ...
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    onClick={() => handleAnalyzeSelectedCall(false)}
                    className="text-xs text-slate-505 hover:text-slate-800 underline cursor-pointer font-bold"
                  >
                    다시 분석
                  </button>
                </div>
