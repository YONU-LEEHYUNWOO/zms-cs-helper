      ...
      >
        ...
        <div className="flex-1 flex overflow-hidden min-h-0 bg-slate-50 border-t border-slate-200">
          ...
          <CtiRecordTable
            ...
            datePreset={cti.datePreset}
            setDatePreset={cti.setDatePreset}
            startDateInput={cti.startDateInput}
            setStartDateInput={cti.setStartDateInput}
            endDateInput={cti.endDateInput}
            setEndDateInput={cti.setEndDateInput}
            handleSelectPreset={cti.handleSelectPreset}
            currentMaxPage={cti.currentMaxPage}
            isLoadingMore={cti.isLoadingMore}
            handleLoadMoreCalls={cti.handleLoadMoreCalls}
